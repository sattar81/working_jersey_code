...
public class GetTcsServiceClient {
    public static final String BASE_URI = "http://localhost:8080/RestWS-1.0-SNAPSHOT";
    public static final String PATH_NAME = "/hello/getEmp/";
